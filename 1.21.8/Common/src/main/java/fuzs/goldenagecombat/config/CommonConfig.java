...
public class CommonConfig implements ConfigCore {
    ...
    @Config(
            description = "Boost sharpness enchantment to 1.25 damage points per level instead of just 0.5.",
            gameRestart = true
    )
