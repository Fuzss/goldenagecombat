...
public class ClientConfig implements ConfigCore {
    ...
    @Config(description = {"Choose a style for the attributes display on item tooltips.", "NONE: No information regarding attributes is added.", "LEGACY: The pre-1.9 attributes style, mainly recognizable for using blue text instead of green.", "MODERN: The current vanilla attribute style."})
